...
\begin{document}
	...
	\begin{itemize}
		...
		\itemtt{USAGE\_LENGTH}: Contiene la lunghezza della stringa, necessaria per la stampa.
	\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\itemtt{\_atoi\_loop}: Loop principale, converte la stringa puntata dal registro \texttt{edi} in un intero salvato e ritornato in \texttt{eax}. 
	\end{itemize}
	...
	\begin{itemize}
		...
		\itemtt{\_set\_alm}: Se il motore è nella modalità \texttt{fg} da più di 15 secondi, viene "acceso" l'allarme portando il valore di \texttt{alm} a 1.
