...
\lstdefinelanguage{MyAssembler}{
	...
	morekeywords=[4]{popl,popb,pushl,pushb,esi,jne,jn,call,int,movl,movb,xorl,xorb,subl,subb,addl,addb,mull,mulb,incl,cmpb,cmpl,jl,jg,jge,jle,je,jmp,ret,decl,leal},
